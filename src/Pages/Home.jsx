...
const WHY_US = [
    { icon: 'fas fa-shield-alt', title: 'Ardhisasa Verified', desc: "Every listing is verified through Kenya's official land registry system for your peace of mind.", color: 'bg-emerald-50 text-emerald-600' },
    { icon: 'fas fa-lock', title: 'Secure Transactions', desc: 'End-to-end encrypted payments via M-Pesa with escrow protection on all deals.', color: 'bg-blue-50 text-blue-600' },
    { icon: 'fas fa-robot', title: 'AI Fraud Detection', desc: 'Our AI scans every listing for fraud signals before it goes live on the platform.', color: 'bg-purple-50 text-purple-600' },
    { icon: 'fas fa-headset', title: '24/7 AI Agent', desc: 'Chat with our intelligent agent anytime — property questions answered instantly.', color: 'bg-orange-50 text-orange-600' },
];

const NEIGHBORHOODS = [
    { name: 'Karen', count: '24 listings', image: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&q=80&w=600' },
    { name: 'Westlands', count: '38 listings', image: 'https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?auto=format&fit=crop&q=80&w=600' },
    { name: 'Kilimani', count: '19 listings', image: 'https://images.unsplash.com/photo-1493809842364-78817add7ffb?auto=format&fit=crop&q=80&w=600' },
    { name: 'Mombasa', count: '12 listings', image: 'https://images.unsplash.com/photo-1506059612708-99d6c258160e?auto=format&fit=crop&q=80&w=600' },
];
...
const TESTIMONIALS = [
    { name: 'James Mwangi', role: 'Property Buyer, Karen', text: 'SecureEstate made finding my dream home so easy. The Ardhisasa verification gave me full confidence in the transaction.', avatar: 'JM', color: 'bg-emerald-500' },
    { name: 'Amina Hassan', role: 'Landlord, Westlands', text: 'I listed my apartment and got a verified tenant within a week. The M-Pesa escrow system is brilliant.', avatar: 'AH', color: 'bg-blue-500' },
    { name: 'Brian Otieno', role: 'Real Estate Agent, Nairobi', text: 'As an agent, the AI fraud detection has saved me from multiple scam listings. This platform is a game changer.', avatar: 'BO', color: 'bg-purple-500' },
];
            ...
            <section className="bg-gray-50 py-20">
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
                        {NEIGHBORHOODS.map((n) => (
                            <Link to="/buy" key={n.name} className="group relative rounded-2xl overflow-hidden h-48 block">
